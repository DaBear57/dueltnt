scoreboard players set @a[gamemode=adventure,scores={timer=19..,class=0}] timer 0
scoreboard players set @a[gamemode=adventure,scores={timer=88..,class=1}] timer 0
...
scoreboard players set @a[gamemode=adventure,scores={timer=8..,class=5}] timer 0
